...
GNU General Public License v3.0 (GPL-3.0) означает:

Вы можете свободно использовать, изучать, модифицировать и распространять этот код
Любые производные работы должны распространяться под той же лицензией
Вы должны предоставить исходный код при распространении приложения
Все изменения должны быть явно обозначены и документированы
Для коммерческого использования или модификаций с другими лицензионными условиями, пожалуйста, свяжитесь с автором для обсуждения дополнительных лицензий.
